...
func main() {
        ...
        if command == "helper" {
                ...
                case "make:domain":
                        ...
                        err := setModuleName()
                        if err != nil {
                                fmt.Printf("Error setting module name: %v\n", err)
                                os.Exit(1)
                        }

                        err = createDomainStructure()
                        if err != nil {
                                fmt.Printf("Error creating domain structure: %v\n", err)
                                os.Exit(1)
                        }
...
func createDomainStructure() error {
        ...
        return createGoFiles(basePath, templates)
}

func createGoFiles(basePath string, templates template) error {
